...
//        option.title().text("能耗情况").x("center");
        ...
        // 设置图例
        option.legend().data("2栋", "3栋", "4栋", "6栋", "7栋", "8栋", "总功率").y("bottom");
        ...
        bar4.name("6栋").data(yAxis4).itemStyle().normal();
        bar5.name("7栋").data(yAxis5).itemStyle().normal();
        bar6.name("8栋").data(yAxis6).itemStyle().normal();
        bar7.name("总功率").data(yAxis7).itemStyle().normal();
        option.series(bar, bar2, bar3, bar4, bar5, bar6, bar7);
